    ...
    return (
        <div className={styles.contenedor}>
            ...
            <div className={styles.contenido}>
                ...
                {/* <Image src={'https://firebasestorage.googleapis.com/v0/b/un-encanto-latinoamericano.appspot.com/o/derivados.jpeg?alt=media&token=45f534d8-cde8-41c0-9526-a3fce3b307c8&_gl=1*15idqoj*_ga*MTQ4ODY2MzM3NS4xNjk0Mjk3MzIx*_ga_CW55HF8NVT*MTY5ODg5MDM0NS40LjEuMTY5ODg5MDY1Ni4xMy4wLjA.'} alt="Imagen" width={550} height={422} className={styles.image} /> */}
                <Image src={''} alt="Imagen" width={550} height={422} className={styles.image} />
            </div>
        </div>
    );
};
